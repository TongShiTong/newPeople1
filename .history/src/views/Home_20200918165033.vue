  ...
  <div class="home-page">
    <div>
      ...
      <van-tabs v-model="active">
        <van-tab title="标签 1">新人专享</van-tab>
        <van-tab title="标签 2">日用百货</van-tab>
        <van-tab title="标签 3">厨房用品</van-tab>
        <van-tab title="标签 4">生活电器</van-tab>
        <van-tab title="标签 4">休闲零食</van-tab>
      </van-tabs>
