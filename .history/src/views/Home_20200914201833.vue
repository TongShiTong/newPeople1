  ...
  <div class="home-page">
    <div>
      ...
      <div class="coupon_box">
        <img src="@/assets/coupon/tu3.png" alt="" @click="getCoupon(442)">
        <img src="@/assets/coupon/tu4.png" alt="" @click="getCoupon(443)">
        <img src="@/assets/coupon/tu5.png" alt="" @click="getCoupon(444)">
      </div>
