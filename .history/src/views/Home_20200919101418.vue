<template>
  <div class="home-page">
    <div>
      ...
      <van-tabs class="van_tabs_box" v-model="active" line-width='20' swipe-threshold="5">
        <van-tab title="新人专享">
          <div class="goods_box">
              ...
              <div class="good_name_box">
                ...
                <div class="good_info">
                  <div class="good_info_box">
                    <span style="font-size:0.24rem;color:#FF2B2B;vertical-align: middle;display: inline-block;width: 0.2rem;">￥</span><span class="price">{{item.price}}</span><span style="vertical-align: middle;">已售{{item.yishou}}件</span>
                  </div>
                  <div class="gwc">
        ...
        <van-tab title="日用百货">日用百货</van-tab>
        <van-tab title="厨房用品">厨房用品</van-tab>
        <van-tab title="生活电器">生活电器</van-tab>
        <van-tab title="休闲零食">休闲零食</van-tab>
      </van-tabs>
  ...
  data() {
    return {
      newNewlist:[
        {
          id: 1,
          img: require('@/assets/coupon/tu39.png'),
          title:"产品名称产品名称",
          tab:'七天无理由退换',
          price: 186,
          yishou: 666,
        ...
        {
          id: 2,
          img: require('@/assets/coupon/tu36.png'),
          title:"产品名称产品名称",
          tab:'七天无理由退换',
          price: 186,
          yishou: 666,
        ...
        {
          id: 3,
          img: require('@/assets/coupon/tu34.png'),
          title:"产品名称产品名称",
          tab:'七天无理由退换',
          price: 186,
          yishou: 666,
  ...
  methods: {
    ...
    getCoupon(id) {
      ...
      api.getCoupon(id).then(data => {
        ...
        // alert(1234,error)
        this.$toast.fail("你已经领取过了，请不要重复领取！");
...
<style>
  ...
  .biaoqian span{
    ...
    color: #FF2B2B;
    line-height: 0.29rem;
    padding: 0.02rem 0.06rem 0rem 0.08rem;
    background: #FFF4F4;
