  ...
  <div class="home-page">
    <div>
      ...
      <div class="coupon_info">
        <img src='@/assets/coupon/tu9.png' alt="" @click="getItem1(118509)">
        <img src='@/assets/coupon/tu10.png' alt="" @click="getItem1(117224)">
  ...
  methods: {
    ...
    couponList() {
      ...
      api.couponList().then(data => {
        // console.log(data)
        if(data[0].is_accept==1) {
          self.lq1 = true
        }else {
          self.lq1 = false
        }
        if(data[1].is_accept==1) {
          self.lq2 = true
        }else {
          self.lq2 = false
        }
        if(data[2].is_accept==1) {
          self.lq3 = true
        }else {
          self.lq3 = false
        }
