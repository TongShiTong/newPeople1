  ...
  <div class="home-page">
    <div>
      <div class="cou_banner">
        <img v-lazy="require('@/assets/coupon/tu1.png')" alt="">
        <img v-lazy="require('@/assets/coupon/tu2.png')" alt="">
      </div>
      <div class="coupon_box">
        <img v-lazy="require('@/assets/coupon/tu3.png')" alt="" @click="getCoupon(442)" v-if="!lq1">
        <img v-lazy="require('@/assets/coupon/tu03.png')" alt="" v-else>
        <img v-lazy="require('@/assets/coupon/tu4.png')" alt="" @click="getCoupon(443)" v-if="!lq2">
      ...
      <div class="cou_banner">
        <img v-lazy="require('@/assets/coupon/tu6.png')" alt="">
      </div>
      <div class="coupon_info">
        <img v-lazy="require('@/assets/coupon/tu7.png')" alt="" @click="getItem1(118509)">
        <img v-lazy="require('@/assets/coupon/tu8.png')" alt="" @click="getItem1(117224)">
        ...
        <img v-lazy="require('@/assets/coupon/tu11.png')" alt="" @click="getItem1(120271)">
        <img v-lazy="require('@/assets/coupon/tu12.png')" alt="" @click="getItem1(120287)">
        <img v-lazy="require('@/assets/coupon/tu13.png')" alt="" @click="getItem1(120286)">
        <img v-lazy="require('@/assets/coupon/tu14.png')" alt="" @click="getItem1(117235)">
      </div>
      <div class="cou_banner">
        <img v-lazy="require('@/assets/coupon/tu15.png')" alt="">
      </div>
      <div class="coupon_info">
        <img v-lazy="require('@/assets/coupon/tu16.png')" alt="" @click="getItem1(120259)">
        <img v-lazy="require('@/assets/coupon/tu17.png')" alt="" @click="getItem1(120268)">
        <img v-lazy="require('@/assets/coupon/tu18.png')" alt="" @click="getItem1(122177)">
        <img v-lazy="require('@/assets/coupon/tu19.png')" alt="" @click="getItem1(122175)">
        <img v-lazy="require('@/assets/coupon/tu20.png')" alt="" @click="getItem1(122171)">
        <img v-lazy="require('@/assets/coupon/tu21.png')" alt="" @click="getItem1(122165)">
        <img v-lazy="require('@/assets/coupon/tu22.png')" alt="" @click="getItem1(120430)">
        <img v-lazy="require('@/assets/coupon/tu23.png')" alt="" @click="getItem1(122161)">
      </div>
      <div class="cou_banner">
...
<script>
import { getToken, setKeyData, getKeyData, getKey, setAgain, getAgain, getfrist1, getfrist2, getfrist3, setfrist1, setfrist2, setfrist3, setLq1, setLq2, setLq3, getLq1, getLq2, getLq3 } from "../store/user";
...
export default {
  ...
  methods: {
    ...
    couponList() {
      ...
      api.couponList().then(data => {
        // console.log(data)
        if(data[0].is_accept==1 || getLq1()==1) {
          self.lq1 = true
        }else {
          self.lq1 = false
        }
        if(data[1].is_accept==1 || getLq2()==1) {
          self.lq2 = true
        }else {
          self.lq2 = false
        }
        if(data[2].is_accept==1 || getLq3()==1) {
          self.lq3 = true
        }else {
          self.lq3 = false
        }
  ...
  mounted() {
    document.getElement.scrollTop = 100
    console.log(888,document.getElement.scrollTop)
  },
  created: function() {
