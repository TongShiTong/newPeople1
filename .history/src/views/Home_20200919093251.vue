              ...
              <div class="good_name_box">
                ...
                <div class="good_info">
                  <div class="good_info_box">
                    <span style="font-size:0.24rem;color:#FF2B2B;vertical-align: middle;display: inline-block;width: 0.16rem;">￥</span><span class="price">186</span><span style="vertical-align: middle;">已售666件</span>
                  </div>
                  <div class="gwc">
