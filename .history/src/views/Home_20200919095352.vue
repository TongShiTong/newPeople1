          ...
          <div class="goods_box">
            <div class="good_item" v-for="(item, index) in newNewlist" :key="index">
              ...
              <div class="good_name_box">
                <div>
                  <div class="title">产品名称产品名称产品名</div>
                  <div class="biaoqian">
                    <span>七天无理由退换</span>
                    <span>满99减10</span>
                    <span>包邮</span>
                ...
                <div class="good_info">
                  <div class="good_info_box">
                    <span style="font-size:0.24rem;color:#FF2B2B;vertical-align: middle;display: inline-block;width: 0.2rem;">￥</span><span class="price">186</span><span style="vertical-align: middle;">已售666件</span>
                  </div>
                  <div class="gwc">
