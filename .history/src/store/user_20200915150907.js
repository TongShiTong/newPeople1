...
export function setLq1(lingqu1) {
  localStorage.setItem("lingqu1", lingqu1);
}

export function getLq1() {
  return localStorage.getItem("lingqu1");
}

export function setLq2(lingqu2) {
  localStorage.setItem("lingqu2", lingqu2);
}

export function getLq2() {
  return localStorage.getItem("lingqu2");
}

export function setLq3(lingqu3) {
  localStorage.setItem("lingqu3", lingqu3);
}

export function getLq3() {
  return localStorage.getItem("lingqu3");
}
